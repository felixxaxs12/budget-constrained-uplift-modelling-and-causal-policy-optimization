...
Before test outcome columns are loaded for evaluation, the pipeline records hashes of the raw file, configuration, category map, source commit, and fitted models together with all selected round counts and software versions.
